...
plot(x = lm_model$fitted.values, y = lm_model$residuals, xlab = 'Fitted Values',
     ylab = 'Residuals', main = 'Plot of Residuals vs. Fits')
abline(h = 0, col = 'red')
```

### Normality of Residuals
```{r}
density_value <- density(lm_model$residuals)
plot(density_value, main = 'Density of Residuals')

# qqnorm(lm_model$residuals, main = 'QQ-Plot')
...
est = lm_model$coefficients['waiting']
me <- qt(0.975, df = 271) * lm_summary$coefficients['waiting', 'Std. Error']
